...
export default function Grid() {
    ...
    function handleSave(index, data) {
        // save to lcal storage and modify the saved workouts state
    ...
    function handleComplete(index, data) {
        //complete workout (so basically we modify the completed status)
        const newObj = {...data}
    ...
    return (
        <div className="training-plan-grid">
            {Object.keys(training_plan).map((workout, workoutIndex) => {
                ...
                }} className={'card plan-card ' + (isLoked ? 'inactive' : '')} key={workoutIndex}>
